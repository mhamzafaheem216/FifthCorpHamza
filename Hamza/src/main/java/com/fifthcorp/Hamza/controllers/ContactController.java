...
import com.fifthcorp.Hamza.services.ContactService;
...
public class ContactController {
    ...
    @GetMapping("/fetchAll")
    @ApiOperation(value = "Fetch All Contacts")
    ...
    @ApiOperation(value = "Fetch Contact By Type")
    public ResponseEntity<Object> getByType(@PathVariable String type, HttpServletRequest request) {
        ...
        public ResponseEntity<Response> create(@RequestBody String obj, HttpServletRequest request) {
            ...
            try {
                Contact createdContact = contactService.createContact(obj);
    ...
    public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody String obj, HttpServletRequest request) {
        if (!Helper.validateToken(request)) {
            return new ResponseEntity<>(new Response("Unauthorized: Invalid token"), HttpStatus.UNAUTHORIZED);
        }

        try {
            Contact updatedContact = contactService.updateContact(id, obj);
